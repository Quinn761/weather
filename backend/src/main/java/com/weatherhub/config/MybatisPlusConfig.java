...
@MapperScan({"com.weatherhub.user", "com.weatherhub.rbac", "com.weatherhub.ai.store", "com.weatherhub.ai.kb", "com.weatherhub.camera"}) // 只扫描 MySQL 上的 Mapper，GIS 走独立的 PostGIS 数据源
